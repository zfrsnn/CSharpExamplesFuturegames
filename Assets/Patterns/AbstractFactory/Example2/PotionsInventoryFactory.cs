...
public class PotionsInventoryFactory : IUIInventoryFactory {
    ...
    public PotionsInventoryFactory(GameObject panelPrefab, GameObject buttonPrefab, GameObject labelPrefab) {
